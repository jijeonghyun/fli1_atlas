...
bedops --intersect *seacr_norm_top0.01.peaks.stringent.bed > masterPeaks.bed
...
#Must use -p to specify that it is paired-end.
featureCounts -a annoPeaks.saf -F SAF -p -o featureCounts.txt *_mapped.bam
